      ...
      <main className="flex-1 p-6 md:ml-0">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="space-y-2">
            ...
            <div className="border-2 border-dashed border-neutral-700 rounded-lg p-8 text-center bg-neutral-800/50">
              <Upload className="h-12 w-12 mx-auto text-neutral-400 mb-4" />
              <p className="text-neutral-400 mb-2">
                Drag and drop a hackathon visual here or
              </p>
              <Button
                variant="outline"
              ...
              <div className="space-y-3">
                <Popover>
                  ...
                  <PopoverContent className="w-auto p-0 bg-neutral-800 border-neutral-700">
                    <Calendar
                      mode="single"
                      selected={hackathonStart}
                      onSelect={setHackathonStart}
                      initialFocus
                    />
                  </PopoverContent>
                </Popover>
          ...
          <div className="space-y-2">
            ...
            <div className="bg-neutral-800 border border-neutral-700 rounded-lg">
              ...
              <div className="border-b border-neutral-700 p-3 flex items-center space-x-2">
