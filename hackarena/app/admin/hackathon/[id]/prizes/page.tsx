  ...
  const toggleCohortExpansion = (id: string) => {
    setPrizeCohorts(
      prizeCohorts.map((cohort) =>
        cohort.id === id ? { ...cohort, expanded: !cohort.expanded } : cohort
      )
    );
  };
            ...
            >
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-neutral-400">{cohort.name}</span>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={cohort.votingMode}>
                        ...
                        <SelectContent className="bg-neutral-800 border-neutral-700">
                          <SelectItem value="project-scoring">
                            Project Scoring
                          </SelectItem>
                          <SelectItem value="ranked-choice">
                            Ranked Choice
                          </SelectItem>
                          <SelectItem value="simple-vote">
                            Simple Vote
                          </SelectItem>
                        </SelectContent>
                      </Select>
