...
export default function JudgeRegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 bg-gray-900 flex flex-col justify-center px-8 lg:px-16">
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold text-white mb-4">You were invited to judge!</h1>
            ...
            <div className="space-y-6">
              ...
              <div className="text-center text-gray-400 text-sm">U&fnaekda88l!0c</div>
          ...
          <div className="mt-16 flex gap-6 text-sm text-gray-500">
      ...
      <div className="hidden lg:block flex-1">
        <div className="h-full bg-gradient-to-br from-orange-400 to-orange-600 relative overflow-hidden">
          <Image src="/modern-office-space-with-developers-working.jpg" alt="Office space" fill className="object-cover" />
        </div>
      </div>
    </div>
  )
