                ...
                <div className="lg:col-span-2 space-y-6">
                  <div>
                    ...
                    <p className="text-neutral-400 leading-relaxed">
                      Dunk Verse is an innovative blockchain-based sports
                      engagement platform designed to revolutionize the fan
                      experience. Leveraging Mantle's Layer 2 infrastructure,
                      the platform combines GameFi, SocialFi, and NFT to offer
                      unique features like AI-generated quizzes, live NFT
                      auctions tied to Top Shots NBA sports events, and
                      leaderboard competitions. Fans can upload videos that are
                  ...
                  <div>
                    ...
                    <p className="text-neutral-400 leading-relaxed">
                      ...
                      Development: Built a user-friendly interface for NFT
                      auctions, AI quizzes, and Social Interaction. - Smart
                      Contracts: Deployed key smart contracts for the token and
                      Betting Pool on the Mantle Testnet. - AI Quiz Integration:
                      Implemented AIGC DALL-E3 GPT models that generate dynamic
                      quizzes based on live sports events. Developed a
                      functional NFT auction system that allows users to bid
                      using our tokens. - Testing and Deployment: Conducted
                      rigorous testing to ensure seamless operations and
                      deployed the project with all features integrated.
                    </p>
                  </div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                              <div>
                                ...
                                <div className="font-semibold">
                                  {hackathon.winner || hackathon.votingClose}
                                </div>
                              </div>
                              <div>
                                <div className="text-sm text-neutral-400">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <Select defaultValue="tech-fairness">
                    <SelectTrigger className="w-full max-w-md bg-neutral-900 border-neutral-700">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="tech-fairness">
                      ...
                      <tbody>
                        {evaluationCriteria.map((criteria, index) => (
                          ...
                          >
                            ...
                            <td className="py-4 px-4 text-neutral-400 max-w-md">
                            ...
                            <td className="py-4 px-4 text-center">
                              <Input
                                ...
                                min="0"
                                className="w-20 mx-auto bg-neutral-900 border-neutral-700 text-center"
                                placeholder="0"
                              />
                            </td>
                          </tr>
