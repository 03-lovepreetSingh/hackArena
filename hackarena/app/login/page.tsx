    ...
    <div className="min-h-screen flex">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <Button
                  variant="outline"
                  className="w-full bg-gray-800 border-gray-700 hover:bg-gray-700 text-white h-12"
                >
                  Metamask Wallet
                </Button>
                <Button
      ...
      <div className="hidden lg:block flex-1">
        <div className="h-full bg-gradient-to-br from-orange-400 to-orange-600 relative overflow-hidden">
          <Image src="/placeholder-r15hy.png" alt="Developers working" fill className="object-cover" />
        </div>
      </div>
    </div>
  )
