  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div>
        ...
        <div className="flex">
          <span className="bg-neutral-800 border border-neutral-700 border-r-0 px-3 py-2 text-neutral-400 rounded-l-lg">
            https://
          </span>
          <Input
            className="bg-neutral-800 border-neutral-700 text-white placeholder:text-neutral-500 rounded-l-none"
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          <div className="flex items-center gap-2">
            <Input
              ...
              className="bg-neutral-800 border-neutral-700 text-white placeholder:text-neutral-500 w-32"
        ...
        <div className="space-y-4">
          ...
          <Button
            variant="outline"
            size="sm"
            className="border-neutral-600 text-blue-400 hover:bg-neutral-700 bg-transparent"
          >
            + Add New Tag
          </Button>
        </div>
