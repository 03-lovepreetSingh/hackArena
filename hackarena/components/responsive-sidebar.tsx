...
export default function ResponsiveSidebar({ items, className }: ResponsiveSidebarProps) {
          ...
          {items.map((item) => (
            <Link
              ...
              className={cn(
                ...
                item.active ? "text-blue-400 bg-blue-900/20" : "text-gray-400 hover:text-white hover:bg-gray-800",
              )}
