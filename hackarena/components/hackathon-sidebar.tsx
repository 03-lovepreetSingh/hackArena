...
export function HackathonSidebar() {
  ...
  return (
    <>
      <aside className="w-80 border-l border-neutral-800 bg-neutral-900 p-6">
        {/* Registration Countdown */}
        <div className="mb-6">
          <p className="text-sm text-neutral-400 mb-2">Left to register</p>
          <div className="grid grid-cols-4 gap-2 mb-4">
            <div className="text-center">
              <div className="text-2xl font-bold">12</div>
              <div className="text-xs text-neutral-400">D</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-neutral-400">M</div>
            </div>
            <div className="text-center">
        ...
        {/* Registration Info */}
        <Card className="bg-neutral-800 border-neutral-700 p-4 mb-6">
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between">
              <span className="text-neutral-400">Total Prize</span>
        ...
        {/* Links */}
        <div className="mb-6">
          <p className="text-sm text-neutral-400 mb-3">Links</p>
