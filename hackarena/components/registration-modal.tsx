      ...
      <DialogContent className="bg-neutral-900 border-neutral-700 text-white max-w-md">
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <Label htmlFor="githubLink" className="text-neutral-300">
                Github Link
              </Label>
              <Input
                id="githubLink"
            ...
            <div>
              <Label htmlFor="twitterLink" className="text-neutral-300">
                Twitter Link{" "}
            ...
            <div>
              <Label htmlFor="telegramHandle" className="text-neutral-300">
                Telegram Handle
              </Label>
              <Input
                id="telegramHandle"
                ...
                className="bg-neutral-800 border-neutral-600 text-white mt-1 border-blue-500"
              />
            </div>

            <div>
              <Label htmlFor="wechatHandle" className="text-neutral-300">
                WeChat Handle
              </Label>
              <Input
                id="wechatHandle"
                ...
                onChange={(e) =>
                  setFormData({ ...formData, wechatHandle: e.target.value })
                }
                className="bg-neutral-800 border-neutral-600 text-white mt-1"
              />
            </div>
