      ...
      <div>
        <div className="flex items-start space-x-6 mb-6">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-400">Tech Fairness Exploration</div>
            <div className="text-sm text-gray-400">Awards (9 winners)</div>
          </div>

          <div className="flex-1">
            <h3 className="text-xl font-bold mb-3">1. Tech Fairness Exploration Awards (9 winners)</h3>
            <p className="text-gray-300 mb-4">
              This track is open to all topics as long as your work addresses "tech fairness." We welcome both builders
              and storytellers—whether you're coding a protocol, designing a governance interface, or building a meme
              engine.
            </p>
            <p className="text-gray-300 mb-4">Suggested directions (not limited to):</p>
            ...
            <p className="text-gray-300">Each selected team will receive 2,000 USD worth of FAIR3 tokens.</p>
          </div>
        </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-600">
                  ...
                  <th className="text-right py-2 text-gray-400">Max Score</th>
                </tr>
              </thead>
              <tbody className="space-y-2">
                ...
                <tr className="border-b border-gray-700">
                  ...
                  <td className="py-3 text-gray-300">
                    Does the project address core fairness challenges (algorithm transparency, data sovereignty,
                    sustainable income, etc.)?
                  </td>
                ...
                <tr className="border-b border-gray-700">
                  ...
                  <td className="py-3 text-gray-300">
                    Can this project be applied to real communities or users? Is it scalable or integrable?
                  </td>
                  <td className="py-3 text-right">20</td>
                </tr>
                <tr>
                  ...
                  <td className="py-3 text-gray-300">
                    Is the presentation intuitive? Is the design and documentation clear enough to be understood and
                    used?
                  </td>
        ...
        <Card className="bg-gray-800 border-gray-700 p-6">
            ...
            <div className="text-center">
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <div className="text-sm text-gray-400">@WizzyOnChain</div>
                </div>
                <div>
                  <div className="font-medium">Doodle</div>
                  <div className="text-sm text-gray-400">@Doodlegenics</div>
                </div>
                <div>
                  <div className="font-medium">lynk</div>
                  <div className="text-sm text-gray-400">@lynkxyz</div>
                </div>
              </div>
            </div>
            <div className="text-center">
          ...
          <div className="text-center">
            <div className="text-lg font-semibold mb-1">Max votes per Judge</div>
            <div>100</div>
          </div>
        </Card>
      </div>
      ...
      <div>
        <div className="flex items-start space-x-6 mb-6">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-400">FAIR3 Public Infrastructure</div>
            <div className="text-sm text-gray-400">Awards (3 winners)</div>
          </div>

          <div className="flex-1">
            <h3 className="text-xl font-bold mb-3">2. FAIR3 Public Infrastructure Awards (3 winners)</h3>
            <p className="text-gray-300 mb-4">
              This track is open to all topics as long as your work addresses "tech fairness." We welcome both builders
              and storytellers—whether you're coding a protocol, designing a governance interface, or building a meme
              engine.
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-600">
                  <th className="text-left py-2 text-gray-400">Name</th>
                  <th className="text-left py-2 text-gray-400">Description</th>
                  <th className="text-right py-2 text-gray-400">Score</th>
                </tr>
              </thead>
              <tbody className="space-y-2">
                <tr className="border-b border-gray-700">
