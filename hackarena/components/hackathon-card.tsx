        ...
        <div className="flex-1 p-6">
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-neutral-400 mb-3">{hackathon.description}</p>
            </div>
          </div>

          <div className="grid grid-cols-4 gap-4 text-sm mb-4">
            <div>
              <span className="text-neutral-400 block">Registration close</span>
            ...
            <div>
              <span className="text-neutral-400 block">Tech stack</span>
            ...
            <div>
              <span className="text-neutral-400 block">Total prize</span>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <Button
                variant="outline"
                size="sm"
                className="border-neutral-600 text-neutral-300 bg-transparent"
              >
                Online
              </Button>
